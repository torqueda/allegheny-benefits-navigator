...
title: 360.4 Deductions from Unearned Rental Income
chapter: 360.4
source_url: http://services.dpw.state.pa.us/oimpolicymanuals/ma/360_NMP_Deductions/360_4_Deductions_from_Unearned_Rental_Income.htm
...
For TANF / GA -related categories of MA , the CAO must consider rental income as unearned income if the property that the individual owns is managed by a rental agency or any other third party and the individual is not responsible for managing the property. Â Â Â Â Â

Â 55 Pa. Code Â§ 181.288 Â

For SSI -related categories of MA, the CAO must count rental income as unearned income unless the rental income is reported to the Internal Revenue Service (IRS). If it is reported to the IRS, the income must be treated as self-employment earned income . (See Chapter 352, Self-Employment, Section 352.42, Renting Real or Personal PropertyâSSI-Related .) Â Â Â Â Â Â

Â Â 55 Pa. Code Â§ 181.107

## 360.41 SSI-Related Deductions

The following are allowable deductions from unearned rental income for SSI-related categories of NMP : Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â

Â Â Â 55 Pa. Code Â§ 181.135
...
NOTE: Â Count rooms in basements and attics if they are used as living spaces. Do not count a bathroom as a room.

...
class IntakeOutput(BaseModel):
    ...
    intake_status: str
    geography_status: str = "unknown_or_ambiguous_geography"
...
class ProgramMatch(BaseModel):
    program_name: str
    status: str
    decision_state: str = "unsupported_or_unknown"
    match_score: float
